...
module.exports = {
  ...
  userToggleDir: path.join(baseDir, '../../json-website/src/components/UserToggle.vue'),
  userLoginDir: path.join(baseDir, '../../json-website/src/components/LoginModal.vue'),
  userRegisterDir: path.join(baseDir, '../../json-website/src/components/RegisterModal.vue'),
